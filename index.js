...
class Keyboard {
  ...
  init() {
    ...
    this.elements.keys.forEach((keyButton, index) => {
  ...
  createKeys() {
    ...
    const keysLayout = this.properties.language === "en" ? this.keysData.keysEn : this.keysData.keysRu;
    keysLayout.forEach((key) => {
      const keyElement = document.createElement("div");
      keyElement.classList.add("key");
      const dividerElement = ["backspace", "\\", "enter", "right-shift"].indexOf(key) !== -1;
      ...
      switch (key) {
        case "backspace":
          ...
          keyElement.addEventListener("click", () => {
            ...
            if (startOfSelection === endOfSelection) {
              parentThis.properties.value = parentThis.properties.value
                .substring(0, parentThis.properties.cursorPosition - 1)
                + parentThis.properties.value.substring(parentThis.properties.cursorPosition);
            } else {
              parentThis.properties.value = parentThis.properties.value
                .substring(0, startOfSelection)
            ...
            parentThis.elements.textContainer.selectionStart = parentThis.properties
              .cursorPosition - 1;
            parentThis.elements.textContainer.selectionEnd = parentThis.properties
              .cursorPosition - 1;
        ...
        case "tab":
          ...
          keyElement.addEventListener("click", (e) => {
            ...
            if (startOfSelection === endOfSelection) {
              parentThis.properties.value = `${parentThis.properties.value.substring(0, startOfSelection)}    ${parentThis.properties.value
                .substring(startOfSelection)}`;
            } else {
              parentThis.properties.value = `${parentThis.properties.value.substring(0, startOfSelection)}    ${parentThis.properties.value
                .substring(endOfSelection)}`;
            }
            parentThis.addText(parentThis.properties.value);
        ...
        case "enter":
          ...
          keyElement.addEventListener("click", () => {
            ...
            parentThis.properties.cursorPosition = startOfSelection;
            if (startOfSelection === endOfSelection) { parentThis.properties.value = `${parentThis.properties.value.substring(0, startOfSelection)}\n${parentThis.properties.value.substring(startOfSelection)}`; } else { parentThis.properties.value = `${parentThis.properties.value.substring(0, startOfSelection)}\n${parentThis.properties.value.substring(endOfSelection)}`; }
        ...
        case "spacebar":
          ...
          keyElement.addEventListener("click", () => {
            ...
            if (startOfSelection === endOfSelection) { parentThis.properties.value = `${parentThis.properties.value.substring(0, startOfSelection)} ${parentThis.properties.value.substring(startOfSelection)}`; } else { parentThis.properties.value = `${parentThis.properties.value.substring(0, startOfSelection)} ${parentThis.properties.value.substring(endOfSelection)}`; }
            parentThis.addText(parentThis.properties.value);
        ...
        case "arrow-left":
          ...
          keyElement.addEventListener("click", () => {
            if (parentThis.elements.textContainer.selectionStart) {
              parentThis.elements.textContainer.selectionStart -= 1;
            } else {
              parentThis.elements.textContainer.selectionStart = 0;
            }
            if (parentThis.elements.textContainer.selectionEnd) {
              parentThis.elements.textContainer.selectionEnd -= 1;
            } else {
              parentThis.elements.textContainer.selectionEnd = 0;
            }
            parentThis.elements.textContainer.focus();
          });
          break;
        case "arrow-right":
          ...
          keyElement.addEventListener("click", () => {
            ...
            if (parentThis.elements.textContainer.selectionEnd < parentThis.elements.textContainer
              .textLength) {
              parentThis.elements.textContainer.selectionEnd += 1;
            } else {
              parentThis.elements.textContainer.selectionEnd = parentThis.elements.textContainer
                .textLength;
            }

            if (parentThis.elements.textContainer.selectionStart < parentThis.elements.textContainer
              .textLength) {
              parentThis.elements.textContainer.selectionStart += 1;
            } else {
              parentThis.elements.textContainer.selectionStart = parentThis.elements.textContainer
                .textLength;
            }
        ...
        default:
          ...
          keyElement.addEventListener("click", () => {
            ...
            if (startOfSelection === endOfSelection) {
              parentThis.properties.value = parentThis.properties.value
                .substring(0, startOfSelection) + keyElement.textContent
  ...
  drawLanguageKeys() {
    const parentThis = this;
    const keysLang = this.properties.language === "en" ? this.keysData.keysEn : this.keysData.keysRu;

    this.elements.keys.forEach((item, index) => {
      if (item.classList.contains("keyboard-lang")) {
        item.textContent = parentThis.properties.capsLock
          ? keysLang[index].toUpperCase() : keysLang[index].toLowerCase();
      }
    });
  ...
  keyUp() {
    ...
    document.addEventListener("keyup", (e) => {
      ...
      parentThis.elements.keys.forEach((item) => {
        ...
        if (e.code === keyAttribute) { item.classList.remove("active"); }

        if (e.code === keyAttribute && (alphabetItem || keyAttribute === "Space")) { parentThis.properties.value += e.key; }
